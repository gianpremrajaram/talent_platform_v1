...
export default function ComingSoon() {
  ...
  return (
    <Stack sx={{ alignItems: 'center', justifyContent: 'center', minHeight: '100vh', py: 2, gap: 4 }}>
      ...
      <Stack
        direction="row"
        sx={{ width: { xs: '95%', md: '40%' }, gap: { xs: 1, sm: 2 }, alignItems: 'center', justifyContent: 'center' }}
      >
      ...
      <Stack sx={{ width: { xs: 340, md: '40%', lg: '30%' }, mt: 2, gap: 2 }}>
        <Typography align="center" color="text.secondary">
