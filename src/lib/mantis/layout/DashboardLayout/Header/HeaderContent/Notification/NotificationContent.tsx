...
// project imports
import { notificationData, Notification, notificationFilterOptions } from './data';
...
interface NotificationContentProps {
  ...
  setFilter: (value: 'all' | 'unread' | 'mentions') => () => void;
  onMarkAllRead: () => void;
}

// ==============================|| NOTIFICATION - CONTENT ||============================== //

export default function NotificationContent({ notifications, filter, setFilter, onMarkAllRead }: NotificationContentProps) {
  return (
    <MainCard
