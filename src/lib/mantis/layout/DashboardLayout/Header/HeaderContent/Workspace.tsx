...
export default function Workspace() {
  ...
  return (
    <Box>
      ...
      >
        <Avatar alt={workspace.title} variant="rounded" src={workspace.image} sx={{ width: 24, height: 24 }} />
                ...
                <MenuList>
                  {workspaceData.map((item, index) => (
                    <MenuItem
                      ...
                      sx={{ gap: 1, px: 1 }}
                    >
                      <Avatar alt={item.title} src={item.image} variant="rounded" sx={{ width: 24, height: 24 }} />
